...
export async function seed_bO6_pML556(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "PML 5.56", category: "light machine gun", game: "BO6", primary: true, secondary: false })
