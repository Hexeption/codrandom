...
export async function seed_bO6_aMES85(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "AMES 85", category: "assault rifle", game: "BO6", primary: true, secondary: false })
