...
export async function seed_bO6_dM10(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "DM-10", category: "marksman rifle", game: "BO6", primary: true, secondary: false })
