...
export async function seed_bO6_modelL(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "Model L", category: "assault rifle", game: "BO6", primary: true, secondary: false })
