...
export async function seed_bO6_lC10(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "LC10", category: "submachine gun", game: "BO6", primary: true, secondary: false })
