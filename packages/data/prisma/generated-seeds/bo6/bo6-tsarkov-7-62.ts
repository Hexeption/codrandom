...
export async function seed_bO6_tsarkov762(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "Tsarkov 7.62", category: "marksman rifle", game: "BO6", primary: true, secondary: false })
