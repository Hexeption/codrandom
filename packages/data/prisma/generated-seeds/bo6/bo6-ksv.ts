...
export async function seed_bO6_kSV(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "KSV", category: "submachine gun", game: "BO6", primary: true, secondary: false })
