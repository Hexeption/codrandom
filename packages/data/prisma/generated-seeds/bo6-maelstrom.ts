...
export async function seed_bO6_maelstrom(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "Maelstrom", category: "shotgun", game: "BO6", primary: true, secondary: false })
