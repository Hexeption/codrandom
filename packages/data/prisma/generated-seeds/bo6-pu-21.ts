...
export async function seed_bO6_pU21(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "PU-21", category: "light machine gun", game: "BO6", primary: true, secondary: false })
