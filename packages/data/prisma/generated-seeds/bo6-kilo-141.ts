...
export async function seed_bO6_kilo141(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "Kilo 141", category: "assault rifle", game: "BO6", primary: true, secondary: false })
