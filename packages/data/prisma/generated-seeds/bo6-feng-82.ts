...
export async function seed_bO6_feng82(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "Feng 82", category: "light machine gun", game: "BO6", primary: true, secondary: false })
