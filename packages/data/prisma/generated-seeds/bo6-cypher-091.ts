...
export async function seed_bO6_cypher091(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "Cypher 091", category: "assault rifle", game: "BO6", primary: true, secondary: false })
