...
export async function seed_bO6_ladra(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "Ladra", category: "submachine gun", game: "BO6", primary: true, secondary: false })
