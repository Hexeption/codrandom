...
export async function seed_bO6_jackalPDW(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "Jackal PDW", category: "submachine gun", game: "BO6", primary: true, secondary: false })
