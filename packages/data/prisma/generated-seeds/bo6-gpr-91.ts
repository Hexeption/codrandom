...
export async function seed_bO6_gPR91(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "GPR 91", category: "assault rifle", game: "BO6", primary: true, secondary: false })
