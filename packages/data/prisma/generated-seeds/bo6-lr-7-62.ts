...
export async function seed_bO6_lR762(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "LR 7.62", category: "sniper rifle", game: "BO6", primary: true, secondary: false })
