...
export async function seed_bO6_krigC(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "Krig C", category: "assault rifle", game: "BO6", primary: true, secondary: false })
