...
export async function seed_core_loadout(prisma: PrismaClient) {
  ...
  await ensureWeapon(prisma, { name: "Knife", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Baseball Bat", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Power Drill", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Cleaver", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Skateboard", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Katanas", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Bo Staff", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Sai", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Nunchaku", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Kali Sticks", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Pickaxe", category: 'melee', game: "BO6", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Sledgehammer", category: 'melee', game: "MW3", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Gutter Knife", category: 'melee', game: "MW3", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Gladiator", category: 'melee', game: "MW3", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Karambit", category: 'melee', game: "MW3", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Soulrender", category: 'melee', game: "MW3", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Tonfa", category: 'melee', game: "MW2", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Combat Knife", category: 'melee', game: "MW2", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Dual Kodachis", category: 'melee', game: "MW2", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Dual Kamas", category: 'melee', game: "MW2", primary: false, secondary: false })
  await ensureWeapon(prisma, { name: "Pickaxe", category: 'melee', game: "MW2", primary: false, secondary: false })
