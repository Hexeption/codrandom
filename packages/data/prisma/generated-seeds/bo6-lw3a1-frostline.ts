...
export async function seed_bO6_lW3A1Frostline(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "LW3A1 Frostline", category: "sniper rifle", game: "BO6", primary: true, secondary: false })
