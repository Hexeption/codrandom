...
export async function seed_bO6_fFAR1(prisma: PrismaClient) {
  const weapon = await ensureWeapon(prisma, { name: "FFAR 1", category: "assault rifle", game: "BO6", primary: true, secondary: false })
